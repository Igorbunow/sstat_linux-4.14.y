...
#ifdef CONFIG_SSTAR_WIFIPLATFORM_XUNWEI
	#define SSTAR_WIFI_PLATFORM			PLATFORM_XUNWEI
#endif
#ifdef CONFIG_SSTAR_WIFIPLATFORM_SUN6I
	#define SSTAR_WIFI_PLATFORM			PLATFORM_SUN6I
#endif
#ifdef CONFIG_SSTAR_WIFIPLATFORM_FRIENDLY
	#define SSTAR_WIFI_PLATFORM			PLATFORM_FRIENDLY
#endif
#ifdef CONFIG_SSTAR_WIFIPLATFORM_SUN6I_64
	#define SSTAR_WIFI_PLATFORM			PLATFORM_SUN6I_64
#endif
#ifdef CONFIG_SSTAR_WIFIPLATFORM_CDLINUX
	#define SSTAR_WIFI_PLATFORM			PLATFORM_CDLINUX
#endif
#ifdef CONFIG_SSTAR_WIFIPLATFORM_AMLOGIC_S805
	#define SSTAR_WIFI_PLATFORM			PLATFORM_AMLOGIC_S805
#endif
#ifdef CONFIG_SSTAR_WIFIPLATFORM_AMLOGIC_905
	#define SSTAR_WIFI_PLATFORM			PLATFORM_AMLOGIC_905
#endif
